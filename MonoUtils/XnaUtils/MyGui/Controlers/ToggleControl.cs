...
{
    class ToggleControl : GuiControl
    {
        private Vector2 origin;


        public ToggleControl(Vector2 position, int radX, int radY, GuiControlDesign design, Norma norma) //gets norma
        {
            this.radX = radX;
            this.radY = radY;
            Position = position;
            ...
            PressedControlColor = new Color(0.95f, 0.95f, 0.45f, 0.6f);
            this.norma = norma;
        ...
        public override void Update(Gui gui, List<TouchState> inputs)
        {
            ...
            if (IsInputOn)
            {
                ...
                {
                    isPressed = MyMath.ToggleBool(isPressed);
                }
            }            
        }
