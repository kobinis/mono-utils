...
{
    class ValueBarControl : GuiControl
    {
        ...
        public ValueBarControl(Vector2 position, int radX, int radY, float minValue, float maxValue, GuiControlDesign design) //gets norma
        {
